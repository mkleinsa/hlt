...
lt1PR2D <- function(x, z, iter, burn, delta, post, ix, ixe, npar, n, nB, J, nDmax, lJ, nT, tJ, accept, eps, display_progress = TRUE) {
    .Call(`_hlt_lt1PR2D`, x, z, iter, burn, delta, post, ix, ixe, npar, n, nB, J, nDmax, lJ, nT, tJ, accept, eps, display_progress)
}
...
lt2PNR <- function(x, iter, burn, delta, post, ix, ixe, npar, n, J, nDmax, lJ, nT, tJ, accept, eps, display_progress = TRUE) {
...
lt2PR <- function(x, z, iter, burn, delta, post, ix, ixe, npar, n, nB, J, nDmax, lJ, nT, tJ, accept, eps, display_progress = TRUE) {
